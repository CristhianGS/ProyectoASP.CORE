...
using AmbientalPrueba1.Data;
using AmbientalPrueba1.Models;
using Microsoft.AspNetCore.Authorization;

namespace AmbientalPrueba1.Controllers
{
    [Authorize]    
    public class CelularesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Moddelo")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Moddelo")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
